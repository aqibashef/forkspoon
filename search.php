<?php get_header(); ?>
	...
	<div class="container">
		...
		<div id="content">
			...
			<div id="main" <?php if(get_theme_mod('fs_sidebar_archive') == true) : ?>class="fullwidth"<?php endif; ?>>
			
				<div class="archive-box">
	
					<span><?php _e( 'Search results for', 'forkspoon' ); ?></span>
					<h1><?php printf( __( '%s', 'forkspoon' ), get_search_query() ); ?></h1>
...
<?php if(get_theme_mod('fs_sidebar_archive')) : else : ?><?php get_sidebar(); ?><?php endif; ?>
<?php get_footer(); ?>