...
class themewagon_latest_news_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => __('Latest Posts', 'forkspoon'), 'number' => 5, 'categories' => '');
		$instance = wp_parse_args( (array) $instance, $defaults ); ?>

		<!-- Widget Title: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', 'forkspoon'); ?></label>
		...
		<!-- Number of posts -->
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e('Number of posts to show:', 'forkspoon'); ?></label>
